 ...
 * 
 */
@WebServiceClient(name = "WebServices", targetNamespace = "http://WebServices/", wsdlLocation = "http://localhost:50725/nextappWebService/WebServices?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICES_QNAME = new QName("http://WebServices/", "WebServices");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:50725/nextappWebService/WebServices?wsdl");
